...
public class EventScraper {
  ...
  public static void main(String[] args) {
    try {
      ...
      html.append(
          ".badge-date{background:#0d6efd; color:white; padding:4px 14px; border-radius:30px; font-size:0.85rem; font-weight:700; display:inline-block; margin-bottom:15px;}");
